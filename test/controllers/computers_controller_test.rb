...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { cpu_id: @computer.cpu_id, gpu_id: @computer.gpu_id, ram: @computer.ram, user_id: @computer.user_id } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { cpu_id: @computer.cpu_id, gpu_id: @computer.gpu_id, ram: @computer.ram, user_id: @computer.user_id } }
